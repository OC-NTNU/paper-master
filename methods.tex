...
\todo[inline]{Should I write more on TEES?}
...
A set of patterns was manually developed from eight of the papers in the corpus, with the remaining two held out as test data. \todo{describe what a pattern is}
